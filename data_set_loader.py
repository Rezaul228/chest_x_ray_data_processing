...
if __name__ == "__main__":
    ...
    try:
        ...
        loader = IndianaDatasetLoader(
            reports_csv_path='/home/rezaul-abedin/Developments/Chest X-rays (Indiana University)multimodal/archive/indiana_reports.csv',
            projections_csv_path='/home/rezaul-abedin/Developments/Chest X-rays (Indiana University)multimodal/archive/indiana_projections.csv',
            image_dir='/home/rezaul-abedin/Developments/Chest X-rays (Indiana University)multimodal/archive/images/images_normalized',
            image_size=(224, 224),
            batch_size=4,
            max_sequence_length=30,
            shard_size=50  # Use smaller shard size for testing
        )
        
        # Save the study data to CSV
        loader.save_study_data('merged_study_data.csv')
